...
class Createategory extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 32.0, middle: 0.3474),
            Pin(size: 21.0, middle: 0.2483),
            child: Text(
              'Hats',
              style: TextStyle(
                fontFamily: 'Avenir Next',
          ...
          Pinned.fromPins(
            Pin(size: 52.0, middle: 0.3517),
            Pin(size: 21.0, middle: 0.4771),
            child: Text(
              'Blanket',
              style: TextStyle(
                fontFamily: 'Avenir Next',
          ...
          Pinned.fromPins(
            Pin(size: 89.0, middle: 0.1977),
            Pin(size: 21.0, middle: 0.2472),
            child: Text(
              'Men Clothes',
              style: TextStyle(
                fontFamily: 'Avenir Next',
          ...
          Pinned.fromPins(
            Pin(size: 116.0, middle: 0.2011),
            Pin(size: 21.0, middle: 0.4016),
            child: Text(
              'Children Clothes',
              style: TextStyle(
                fontFamily: 'Avenir Next',
          ...
          Pinned.fromPins(
            Pin(size: 119.0, middle: 0.2015),
            Pin(size: 21.0, middle: 0.4793),
            child: Text(
              'Household items',
              style: TextStyle(
                fontFamily: 'Avenir Next',
