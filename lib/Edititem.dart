    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 132.0, end: 30.0),
            Pin(size: 63.0, middle: 0.2124),
            child: Container(
              decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            Pin(size: 74.0, start: 250.0),
            Pin(size: 21.0, middle: 0.2248),
            child: Text(
              'Winter hat',
              style: TextStyle(
                fontFamily: 'Avenir Next',
...
const String _svg_q9epeo =
    '<svg viewBox="250.0 243.5 1357.5 1.0" ><path transform="translate(250.0, 243.5)" d="M 0 0 L 1357.5 0" fill="none" stroke="#ededed" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_fy3py8 =
    '<svg viewBox="250.0 313.5 1357.5 1.0" ><path transform="translate(250.0, 313.5)" d="M 0 0 L 1357.5 0" fill="none" stroke="#ededed" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
