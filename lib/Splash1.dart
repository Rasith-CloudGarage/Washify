              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromPins(
                    ...
                    Pin(start: -221.0, end: -208.0),
                    child:
                        // Adobe XD layer: 'IMG_3547' (shape)
                        Container(
                      decoration: BoxDecoration(
...
const String _svg_ncpnod =
    '<svg viewBox="0.0 0.0 375.0 812.0" ><defs><linearGradient id="gradient" x1="0.5" y1="0.0" x2="0.5" y2="1.0"><stop offset="0.0" stop-color="#ffd1ceff"  /><stop offset="1.0" stop-color="#ffc9e9ff"  /></linearGradient></defs><path  d="M 0 0 L 375 0 L 375 812 L 0 812 L 0 0 Z" fill="url(#gradient)" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
