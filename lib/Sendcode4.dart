...
import './Sendcode3.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Sendcode4 extends StatelessWidget {
                    ...
                    child: Column(
                      children: <Widget>[
                        Container(
                          ...
                          child: Text(
                            'We are going to send you a code',
                            style: TextStyle(
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                            child: Text('Next'),
                            onPressed: () {
                              Route route = MaterialPageRoute(builder: (context) => Sendcode3());
                              Navigator.pushReplacement(context, route);
                            },
                            style: ButtonStyle(
...
const String _svg_wyv1zz =
    '<svg viewBox="14.5 321.5 347.0 1.0" ><path transform="translate(14.5, 321.5)" d="M 0 0 L 347 0" fill="none" stroke="#2a323c" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
