    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 115.0, middle: 0.3632),
            Pin(size: 19.0, middle: 0.2221),
            child: Text(
              '+380 69 835 99 77',
              style: TextStyle(
                fontFamily: 'Avenir Next',
          ...
          Pinned.fromPins(
            Pin(size: 156.0, middle: 0.2038),
            Pin(size: 19.0, middle: 0.375),
            child: Text(
...
const String _svg_trax5a =
    '<svg viewBox="260.5 238.5 1347.0 1.0" ><path transform="translate(260.5, 238.5)" d="M 0 0 L 1347 0" fill="none" stroke="#ededed" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_xgazea =
    '<svg viewBox="260.5 308.5 1347.0 1.0" ><path transform="translate(260.5, 308.5)" d="M 0 0 L 1347 0" fill="none" stroke="#ededed" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_nr110y =
    '<svg viewBox="260.5 378.5 1347.0 1.0" ><path transform="translate(260.5, 378.5)" d="M 0 0 L 1347 0" fill="none" stroke="#ededed" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_l987i =
    '<svg viewBox="260.5 588.5 1347.0 1.0" ><path transform="translate(260.5, 588.5)" d="M 0 0 L 1347 0" fill="none" stroke="#ededed" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_fxivle =
    '<svg viewBox="260.5 448.5 1347.0 1.0" ><path transform="translate(260.5, 448.5)" d="M 0 0 L 1347 0" fill="none" stroke="#ededed" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_erdn2 =
    '<svg viewBox="260.5 658.5 1347.0 1.0" ><path transform="translate(260.5, 658.5)" d="M 0 0 L 1347 0" fill="none" stroke="#ededed" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_q5u =
    '<svg viewBox="260.5 518.5 1347.0 1.0" ><path transform="translate(260.5, 518.5)" d="M 0 0 L 1347 0" fill="none" stroke="#ededed" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_h89j2m =
    '<svg viewBox="260.5 728.5 1347.0 1.0" ><path transform="translate(260.5, 728.5)" d="M 0 0 L 1347 0" fill="none" stroke="#ededed" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
