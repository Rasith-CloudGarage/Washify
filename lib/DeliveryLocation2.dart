...
import './Listofcars217.dart';
import 'package:adobe_xd/page_link.dart';
import './DeliveryLocationSearch2.dart';
import './DeliveryLocation6.dart';
import 'package:flutter_svg/flutter_svg.dart';

class DeliveryLocation2 extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: 0.0, end: 0.0),
            Pin(start: 234.0, end: -6.0),
            child:
                // Adobe XD layer: 'IMG_3147' (shape)
                Container(
              decoration: BoxDecoration(
            ...
            child:
              ...
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => DeliveryLocationSearch2(),
                ),
              ],
              child: Container(
                decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            Pin(size: 100.0, middle: 0.2509),
            Pin(size: 19.0, start: 108.0),
            child: Text(
              'Pick-up location',
              style: TextStyle(
                fontFamily: 'SF Pro Text',
          ...
          Pinned.fromPins(
            Pin(size: 103.0, middle: 0.2537),
            Pin(size: 19.0, middle: 0.1992),
            child: Text(
              'Delivery location',
              style: TextStyle(
                fontFamily: 'SF Pro Text',
          ...
          Pinned.fromPins(
            Pin(size: 13.0, start: 25.0),
            Pin(size: 13.0, start: 111.0),
            child: Container(
              decoration: BoxDecoration(
                borderRadius:
          ...
          Pinned.fromPins(
            Pin(size: 5.0, start: 29.0),
            Pin(size: 5.0, middle: 0.2057),
            child: Container(
              decoration: BoxDecoration(
                borderRadius:
                    BorderRadius.all(Radius.elliptical(9999.0, 9999.0)),
          ...
          Pinned.fromPins(
            Pin(size: 161.0, start: 54.0),
            Pin(size: 20.0, middle: 0.2513),
            child: PageLink(
              links: [
                PageLinkInfo(
                  transition: LinkTransition.Fade,
