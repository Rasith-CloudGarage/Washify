...
class Sendcode6 extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: 0.0, end: 0.0),
            Pin(size: 157.0, end: 106.0),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
                  Pin(start: -605.0, end: -50.0),
                  child:
                      // Adobe XD layer: 'IMG_3563' (shape)
                      Container(
                    decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            Pin(size: 61.0, start: 14.0),
            Pin(size: 22.0, middle: 0.3051),
            child: Text(
              'Pick-up ',
              style: TextStyle(
          ...
          Pinned.fromPins(
            Pin(size: 199.0, start: 14.0),
            Pin(size: 49.0, middle: 0.1966),
            child: Text(
              'Date & time',
              style: TextStyle(
                fontFamily: 'SF Pro Text',
...
const String _svg_g65sc =
    '<svg viewBox="0.5 486.5 375.0 1.0" ><path transform="translate(0.5, 486.5)" d="M 0 0 L 375 0" fill="none" stroke="#ededed" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
