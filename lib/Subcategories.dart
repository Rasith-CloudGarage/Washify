...
import './Createsubcategory1.dart';
import './Orders.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 9.3, start: 242.2),
            Pin(size: 15.2, start: 34.0),
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Createsubcategory1(),
                ),
              ],
              child: Text(
                ' Edit',
          ...
          Pinned.fromPins(
            Pin(size: 33.3, start: 261.0),
            Pin(size: 28.6, middle: 0.5573),
            child: SvgPicture.string(
              _svg_sc1a7y,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
          ...
          Pinned.fromPins(
            Pin(size: 36.0, start: 260.0),
            Pin(size: 33.0, middle: 0.2449),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
          ...
          Pinned.fromPins(
            Pin(size: 35.6, start: 260.0),
            Pin(size: 32.3, middle: 0.3195),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
          ...
          Pinned.fromPins(
            Pin(size: 27.5, start: 264.0),
            Pin(size: 39.6, middle: 0.3987),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
          ...
          Pinned.fromPins(
            Pin(size: 37.8, start: 259.0),
            Pin(size: 25.3, middle: 0.4788),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
