    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 1.0, middle: 0.6593),
            Pin(size: 23.0, middle: 0.2797),
            child: SvgPicture.string(
              _svg_h11mu0,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
          ...
          Pinned.fromPins(
            Pin(size: 39.0, start: 289.2),
            Pin(size: 20.0, end: 98.0),
            child: Text(
              '- 15%',
              style: TextStyle(
                fontFamily: 'Avenir Next',
          ...
          Pinned.fromPins(
            Pin(size: 6.9, middle: 0.2061),
            Pin(size: 11.2, end: 100.2),
            child: Transform.rotate(
              angle: 1.5708,
              child:
                  // Adobe XD layer: 'arrow' (group)
...
const String _svg_h11mu0 =
    '<svg viewBox="1111.5 249.5 1.0 23.0" ><path transform="translate(1111.5, 249.5)" d="M 0 0 L 0 23" fill="none" stroke="#000000" stroke-width="2" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
