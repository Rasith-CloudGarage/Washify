...
import './CreateLaundry.dart';
import './Laundries1.dart';
import './Orders.dart';
import './Drivers.dart';
import './Clients.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 253.0, middle: 0.7043),
            Pin(size: 19.0, middle: 0.3281),
            child: Text(
              'andrew’s laundryclean_good@gmail.com',
              style: TextStyle(
                fontFamily: 'Avenir Next',
                fontSize: 14,
                color: const Color(0xff393939),
