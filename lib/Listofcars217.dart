...
import './Listofcars28.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Listofcars217 extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 5.6, middle: 0.8138),
            Pin(size: 9.2, start: 54.2),
