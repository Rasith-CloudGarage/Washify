...
class Laundries1 extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 182.0, middle: 0.6312),
            Pin(size: 19.0, middle: 0.25),
            child: Text(
              'andrew’s laundry@gmail.com',
              style: TextStyle(
                fontFamily: 'Avenir Next',
                fontSize: 14,
                color: const Color(0xff393939),
          ...
          Pinned.fromPins(
            Pin(size: 212.0, middle: 0.7953),
            Pin(size: 19.0, middle: 0.3281),
            child: Text(
              '735 Ave Ambarcadero Blvrd Street',
              style: TextStyle(
                fontFamily: 'Avenir Next',
                fontSize: 14,
                color: const Color(0xff393939),
          ...
          Pinned.fromPins(
            Pin(size: 35.0, middle: 0.224),
            Pin(size: 19.0, middle: 0.6373),
            child: Text(
              'NTAG',
              style: TextStyle(
                fontFamily: 'Avenir Next',
          ...
          Pinned.fromPins(
            Pin(size: 113.0, middle: 0.2351),
            Pin(size: 19.0, middle: 0.5592),
            child: Text(
              'Good Clean Smart',
              style: TextStyle(
                fontFamily: 'Avenir Next',
          ...
          Pinned.fromPins(
            Pin(size: 166.0, middle: 0.2433),
            Pin(size: 19.0, middle: 0.7935),
            child: Text(
          ...
          Pinned.fromPins(
            Pin(size: 55.0, middle: 0.1771),
            Pin(size: 55.0, middle: 0.3151),
            child: Container(
              decoration: BoxDecoration(
                borderRadius:
          ...
          Pinned.fromPins(
            Pin(size: 55.0, middle: 0.1771),
            Pin(size: 55.0, middle: 0.2384),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: -20.0, end: -55.0),
...
const String _svg_tav3xc =
    '<svg viewBox="250.0 613.5 1357.5 1.0" ><path transform="translate(250.0, 613.5)" d="M 0 0 L 1357.5 0" fill="none" stroke="#ededed" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_yubc0 =
    '<svg viewBox="250.0 683.5 1357.5 1.0" ><path transform="translate(250.0, 683.5)" d="M 0 0 L 1357.5 0" fill="none" stroke="#ededed" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
